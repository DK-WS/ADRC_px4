...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/ws/minisnap-1.0/src/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/ws/minisnap-1.0/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /home/ws/minisnap-1.0/install)
...
if(NOT "/home/ws/minisnap-1.0/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ws/minisnap-1.0/src/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
